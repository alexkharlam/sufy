...
class CreateNoteView extends View {
  ...
  _openModal() {
    ...
    this._parentElement.classList.add("create-note-window-active");
    this._outline.classList.add("outline-active");
    // focus on field
    this._title.focus();
  ...
  _closeModal() {
    this._outline.classList.remove("outline-active");
    this._parentElement.classList.remove("create-note-window-active");
  }
